...
from .properties.signal_generator_properties import BaseSignalProps, MACrossoverProps, RSIProps, AsiaMinMaxProps
from .signals.signal_ma_crossover import SignalMACrossover
from .signals.signal_asia_minmax import SignalAsiaMinMax
...
class SignalGenerator(ISignalGenerator):
    ...
    def _get_signal_generator_method(self, signal_props: BaseSignalProps) -> ISignalGenerator:
        ...
        elif isinstance(signal_props, AsiaMinMaxProps):
            return SignalAsiaMinMax(properties=signal_props)
